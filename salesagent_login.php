...
if (isset($_POST['submit'])){
  ...
  $sql="SELECT * FROM sales_agent_login WHERE username='$username' AND pass='$pass'";
 ...
 <style>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="salesagent_login.php">Login</a>
        </li>
        <li class="nav-item">
...
<form action="salesagent_login.php" method="post">
